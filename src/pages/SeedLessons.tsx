      ...
      <div className="container mx-auto max-w-4xl">
            ...
            {loading && (
              <div className="space-y-4">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold">Generating Lessons...</h3>
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground">
          <p>
            ...
            <code className="bg-muted px-2 py-1 rounded">lessonCount</code> variable in{" "}
            <code className="bg-muted px-2 py-1 rounded">supabase/functions/seed-lessons/index.ts</code>
          </p>
        </div>
      </div>
    </div>
